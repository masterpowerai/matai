...
# TestP2PConn: A peer we use to send messages to masterpoweraid, and store responses.
...
#            "-txindex",
    ...
    # This test actually causes masterpoweraid to (reasonably!) disconnect us, so do this last.
    ...
    # masterpoweraid's choice of nonce.
    ...
    # Test that masterpoweraid requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for masterpoweraid to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # masterpoweraid will not send blocktxn responses for blocks whose height is
