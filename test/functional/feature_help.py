...
"""Verify that starting masterpoweraid with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start masterpoweraid with -h for help text")
        ...
        self.log.info("Start masterpoweraid with -version for version information")
        ...
        self.log.info("Start masterpoweraidd with -fakearg to make sure it does not start")
