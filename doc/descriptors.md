# Support for Output Descriptors in masterpowerai Core

Since masterpowerai Core v0.17, there is support for Output Descriptors. This is a
...
existing masterpowerai Core wallets, a convenience function `combo` is
...
All RPCs in masterpowerai Core will include the checksum in their output. Only
