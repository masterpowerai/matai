...
- [`595826ad6`](https://github.com/masterpowerai/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`b451094e2`](https://github.com/masterpowerai/commit/b451094e2) Merge #11490: Disconnect from outbound peers with bad headers chains
...
- [`6ec77c0a7`](https://github.com/masterpowerai/commit/6ec77c0a7) Merge #11131: rpc: Write authcookie atomically
...
- [`37250c02e`](https://github.com/masterpowerai/commit/37250c02e) Merge #11150: [tests] Add getmininginfo test
...
- [`21eca6481`](https://github.com/masterpowerai/commit/21eca6481) BIP143: Signing logic
...
- [`05bed7009`](https://github.com/masterpowerai/commit/05bed7009) Merge #10833: Fix typos
...
- [`ac80c9012`](https://github.com/masterpowerai/commit/ac80c9012) Merge #11012: Make sure to clean up mapBlockSource if we've already seen the block
...
- [`60b3ae182`](https://github.com/masterpowerai/commit/60b3ae182) add gArgs
...
- [`c123e10cc`](https://github.com/masterpowerai/commit/c123e10cc) #10193 scripted-diff: Remove `#include <boost/foreach.hpp>`
...
- [`17177202a`](https://github.com/masterpowerai/commit/17177202a) Merge #10557: Make check to distinguish between orphan txs and old txs more efficient.
...
- [`f2a477646`](https://github.com/masterpowerai/commit/f2a477646) Merge #9544: [trivial] Add end of namespace comments. Improve consistency.
...
- [`3bae86b62`](https://github.com/masterpowerai/commit/3bae86b62) Merge #10582: Pass in smart fee slider value to coin control dialog
...
- [`5edec30db`](https://github.com/masterpowerai/commit/5edec30db) Merge #10523: Perform member initialization in initialization lists where possible
...
- [`60475f127`](https://github.com/masterpowerai/commit/60475f127) Merge #11831: Always return true if AppInitMain got to the end
...
- [`6b548bf37`](https://github.com/masterpowerai/commit/6b548bf37) Merge #10388: Output line to debug.log when IsInitialBlockDownload latches to false
...
- [`6b9e864a0`](https://github.com/masterpowerai/commit/6b9e864a0) Merge #10187: tests: Fix test_runner return value in case of skipped test
...
- [`dfabead29`](https://github.com/masterpowerai/commit/dfabead29) Merge #10264: [test] Add tests for getconnectioncount, getnettotals and ping
...
- [`07b4c08bd`](https://github.com/masterpowerai/commit/07b4c08bd) Merge #9951: Wallet database handling abstractions/simplifications
...
- [`f893ac66c`](https://github.com/masterpowerai/commit/f893ac66c) Merge #10124: [test] Suppress test logging spam
...
- [`9f07f489d`](https://github.com/masterpowerai/commit/9f07f489d) Merge #10047: [tests] Remove unused variables and imports
...
- [`0d2f2b361`](https://github.com/masterpowerai/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/masterpowerai/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/masterpowerai/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/masterpowerai/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/masterpowerai/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/masterpowerai/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/masterpowerai/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/masterpowerai/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/masterpowerai/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/masterpowerai/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/masterpowerai/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/masterpowerai/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/masterpowerai/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/masterpowerai/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/masterpowerai/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/masterpowerai/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/masterpowerai/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/masterpowerai/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/masterpowerai/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/masterpowerai/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/masterpowerai/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/masterpowerai/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/masterpowerai/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/masterpowerai/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/masterpowerai/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/masterpowerai/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/masterpowerai/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/masterpowerai/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/masterpowerai/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/masterpowerai/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/masterpowerai/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/masterpowerai/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/masterpowerai/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/masterpowerai/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/masterpowerai/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/masterpowerai/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/masterpowerai/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/masterpowerai/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/masterpowerai/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/masterpowerai/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/masterpowerai/commit/1cfda206a) Merge #9993: Initialize nRelockTime
