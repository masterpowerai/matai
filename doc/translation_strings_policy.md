...
This document provides guidelines for internationalization of the masterpowerai Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `masterpowerai_en.ts` remains unchanged.
