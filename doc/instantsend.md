...
This mechanism has been integrated into Bitcore-Node-masterpowerai which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/masterpoweraipay/insight-api-masterpowerai#web-socket-api](https://github.com/masterpoweraipay/insight-api-masterpowerai#web-socket-api)
* API: [https://github.com/masterpoweraipay/insight-api-masterpowerai#instantsend-transactions](https://github.com/masterpoweraipay/insight-api-masterpowerai#instantsend-transactions)
