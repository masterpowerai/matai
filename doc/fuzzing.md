# Fuzzing masterpowerai Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing masterpowerai Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/masterpowerai/blob/develop/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/masterpowerai/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/masterpowerai/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/masterpowerai/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the masterpowerai Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make masterpowerai Core more robust.
...
with certain assembly code from masterpowerai Core's code. See [developer notes on sanitizers](https://github.com/masterpowerai/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing masterpowerai Core using afl++

## Quickstart guide

To quickly get started fuzzing masterpowerai Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing masterpowerai Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing masterpowerai Core using [Honggfuzz](https://github.com/google/honggfuzz):
