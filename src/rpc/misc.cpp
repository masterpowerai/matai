...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"masterpowerai\" activates all masterpowerai-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "masterpowerai")
    + HelpExampleRpc("debug", "masterpowerai+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The masterpowerai address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The masterpowerai address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of powerai"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of powerai of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in powerai"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in powerai"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in powerai"},
                    {RPCResult::Type::NUM, "received", "The total number of powerai received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "masterpowerai-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* masterpowerai features */
    { "masterpowerai",               "mnsync",                 &mnsync,                 {} },
    { "masterpowerai",               "spork",                  &spork,                  {"command"} },
    { "masterpowerai",               "sporkupdate",            &sporkupdate,            {"name","value"} },
