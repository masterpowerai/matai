...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 MTAI irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on masterpoweraicentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "masterpowerai",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "masterpowerai",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "masterpowerai",               "gobject",                &gobject,                {} },
    { "masterpowerai",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
