...
//! Interface for the src/evo part of a masterpowerai node (masterpoweraid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a masterpowerai node (masterpoweraid process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a masterpowerai node (masterpoweraid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a masterpowerai node (masterpoweraid process).
...
//! Top-level interface for a masterpowerai node (masterpoweraid process).
class Node
{
public:
    virtual ~Node() {}
