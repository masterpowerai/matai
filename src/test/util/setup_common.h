...
/* Initialize masterpowerai-specific components after chainstate initialization */
void masterpoweraiTestSetup(NodeContext& node);
void masterpoweraiTestSetupClose(NodeContext& node);
