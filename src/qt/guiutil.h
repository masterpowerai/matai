...
/** Utility functions used by the masterpowerai Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "masterpowerai:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load masterpowerai specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a masterpowerai specific theme is activated (light/dark).*/
