 ...
 *  We have 4 times smaller block times in masterpowerai, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        masterpowerai Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // MTAI this code also handles non-TXs (masterpowerai specific messages)
