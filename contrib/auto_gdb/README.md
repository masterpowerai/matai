# Contents
This directory contains tools to automatically get data about the memory consumption by some objects in masterpoweraid process with the help of GDB debugger.

## masterpowerai_dbg.sh
This shell script attaches GDB to the running masterpoweraid process (should be built with debug info), executes debug.gdb script and detaches.
By default it uses testnet settings, see script comments to attach it to mainnet masterpoweraid.
