...
masterpoweraipay/masterpowerai repository.
...
Setup
---------
Configuring the github-merge tool for the masterpowerai Core repository is done in the following way:

    git config githubmerge.repository masterpoweraipay/masterpowerai
...
A script to optimize png files in the masterpowerai
...
If there are any errors the return value will be 1 and output like this will be printed:
    ...
    .../64/test_masterpowerai: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_masterpowerai: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_masterpowerai: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_masterpowerai: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
