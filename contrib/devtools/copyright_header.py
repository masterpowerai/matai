...
EXCLUDE = [
    # auto generated:
    'src/qt/masterpoweraistrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The masterpowerai Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a masterpowerai Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The masterpowerai Core developers'
...
Arguments:
    <base_directory> - The base directory of masterpowerai Core source code repository.
"""
...
Arguments:
    <file> - A source file in the masterpowerai Core repository.
"""
