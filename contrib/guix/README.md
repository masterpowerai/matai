# Bootstrappable masterpowerai Core Builds

This directory contains the files necessary to perform bootstrappable masterpowerai
Core builds.
...
To build masterpowerai Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      masterpowerai Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/masterpowerai-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/masterpoweraipay/guix.sigs).
...
[guix-docker]: https://github.com/masterpowerai/tree/master/contrib/guix/Dockerfile
